        ...
        <div className="w-[40%] h-[80%] ml-12 ">
          <div>
            ...
            <h1 className="text-2xl font-bold">
              I'm a <span className="text-teal-500"> Full Stack Devloper </span>
            </h1>
          </div>
          <div className="mt-3">
            <p>
              My name is Sahil kumar. i am resident of village LakhanMajra{" "}
              <br /> near Rohtak. And I have completed my studies from G.P.Meham <br />
          ...
          <div className="mt-5 flex space-x-3">
            ...
            <a href="https://www.linkedin.com/in/sahil-rohilla-/"  target="blank"> <TiSocialLinkedinCircular className="h-[40px] w-[40px]"  /></a>
              
            </div>
            <div className="p-2 rounded-full hover:shadow-green hover:text-green-500 transition duration-300 hover:cursor-pointer">
            <a href="https://github.com/rohillasahil123"  target="blank"> <BsGithub className="h-[40px] w-[40px] " /> </a>
              
            </div>
            <div className="p-2 rounded-full hover:shadow-rose  hover:text-rose-500 transition duration-300 hover:cursor-pointer">
               <a href="https://www.instagram.com/b_a_d_b_o_y__7_0_4_/" target="blank">  <FaInstagram className="h-[40px] w-[40px] " /> </a>
            </div>
            ...
            <button className="hover:bg-teal-500 border-white text-teal-500 hover:shadow-teal  hover:text-black  mt-4 h-10 w-20 text-[18px] rounded-xl">Contect</button>
